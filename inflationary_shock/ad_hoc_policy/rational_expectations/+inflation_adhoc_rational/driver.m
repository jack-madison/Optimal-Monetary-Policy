...
options_ = [];
M_.fname = 'inflation_adhoc_rational';
...
diary off;
diary('inflation_adhoc_rational.log');
...
M_.mapping.x.eqidx = [1 3 4 6 ];
M_.mapping.pi.eqidx = [2 3 6 ];
M_.mapping.i.eqidx = [4 6 ];
M_.mapping.e.eqidx = [3 5 ];
...
save('inflation_adhoc_rational_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('inflation_adhoc_rational_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('inflation_adhoc_rational_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('inflation_adhoc_rational_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('inflation_adhoc_rational_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('inflation_adhoc_rational_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('inflation_adhoc_rational_results.mat', 'oo_recursive_', '-append');
end
