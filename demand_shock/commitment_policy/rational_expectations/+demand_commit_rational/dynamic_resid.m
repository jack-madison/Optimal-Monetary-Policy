...
if T_flag
    T = demand_commit_rational.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(11, 1);
...
residual(3) = T(1)*y(15);
residual(4) = y(16)+params(7)*y(21)*(-params(5))-y(15);
...
residual(9) = y(7)-(y(11)*params(1)+params(2)*y(6));
residual(10) = y(6)-(y(10)-T(1)*(y(8)-y(11))+y(9));
